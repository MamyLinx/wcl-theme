   ...
   $('body').on("created", '[name^="select_"]',function(evt) {
    ...
    if(typeof $.fancybox == 'function') {
        $("a.fancybox").fancybox({
            ...
            tpl: {
                prev: '<a title="'+bender_black.fancybox_prev+'" class="fancybox-nav fancybox-prev"><span></span></a>',
                next: '<a title="'+bender_black.fancybox_next+'" class="fancybox-nav fancybox-next"><span></span></a>',
                closeBtn : '<a title="'+bender_black.fancybox_closeBtn+'" class="fancybox-item fancybox-close" href="javascript:;"></a>'
            }
        });
