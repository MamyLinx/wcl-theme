...
<div class="card col-md-6 mx-auto px-4">
    <div class="card-body">
		  <div class="card-title">
	        <span class="h4"><?php _e('Register an account for free', 'bender_black'); ?></span>
	     </div><hr>
        <form name="register" action="<?php echo osc_base_url(true); ?>" method="post" >
            ...
            <div class="control-group">
                <label class="control-label" for="password2"><?php _e('Repeat password', 'bender_black'); ?></label>
                <div class="controls">
            ...
            <div class="control-group">
                <div class="controls">
                    <button type="submit" class="btn btn-primary mt-2"><?php _e("Create", 'bender_black'); ?></button>
                </div>
            </div>
        </form>
    </div>
