...
<div class="card">
    <div class="card-body">
	    <div class="card-title">
	        <span class="h3"><?php _e('Send to a friend', 'bender_black'); ?></span>
	    </div>
        <ul id="error_list"></ul>
        <form name="sendfriend" action="<?php echo osc_base_url(true); ?>" method="post" >
            ...
            <div class="control-group">
                <label class="control-label" for="yourEmail"><?php _e("Your e-mail",'bender_black'); ?></label>
                <div class="controls ">
            ...
            <?php } ?>
            <div class="control-group">
                <label class="control-label" for="friendName"><?php _e("Your friend's name",'bender_black'); ?></label>
                <div class="controls">
                    <?php SendFriendForm::friend_name(); ?>
                </div>
            </div>
            <div class="control-group">
                <label for="friendEmail"><?php _e("Your friend's e-mail address", 'bender_black'); ?></label> </label>
                <div class="controls">
            ...
            <div class="control-group">
                <label class="control-label" for="subject">
                    <?php _e('Subject (optional)', 'bender_black'); ?>
                </label>
                <div class="controls">
